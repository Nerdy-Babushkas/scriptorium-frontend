    ...
    function renderItems(items, type) {
        items.forEach(item => {
            ...
            if (type === 'music') {
                ...
                const poster = (item.poster || item.Poster) !== "N/A" ? (item.poster || item.Poster) : 'https://via.placeholder.com/300x450?text=No+Poster';
            ...
            card.className = "group bg-[#0f191e] border border-white/10 rounded-2xl overflow-hidden hover:border-[#00C49A] transition-all flex flex-col hover:shadow-lg animate-fade-in-down";
            card.innerHTML = `
