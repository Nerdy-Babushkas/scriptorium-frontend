...
const interactiveObjects = {
  'finished':  { action: 'shelf', key: 'finished',  label: 'Finished' },
...
function init() {
  ...
  loader.load(
    ...
    (gltf) => {
      ...
      camera.position.set(
        center.x,
        center.y - size.y * 0.1,  // slightly below center = eye level
        center.z + size.z * 0.8    // further back
);

      controls.target.set(center.x, center.y, center.z - size.z * 0.1);
      controls.update();
